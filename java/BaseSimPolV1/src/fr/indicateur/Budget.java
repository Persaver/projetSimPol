...
public class Budget {
	private static int ageTravail = 19;			// L'age à partir duquel les citoyens travaillent 
...
//	private static int prixVie = 900;				// Ce que doit toucher au minimum, un salarié pour vivre chaque mois.
...
//	private static int salaireTotalVerse;
	...
	public static int pauvrete(Population p){
		int a = p.nbIndiv(ageTravail, ageRetraite);										// On récupère tous les citoyens en age de travailler
...
//		System.out.println("pauvreteC = " + pauvreteC);
		int pauvrete = (int)(pauvreteO*ratio+pauvreteC*(100-ratio))/100;				// On reunifie les chiffres des cadres et ceux des ouvriers, le résultat sera en %
		return 100-pauvrete;
	}
