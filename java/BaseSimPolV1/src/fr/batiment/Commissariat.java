...
public class Commissariat extends Batiment{
	...
	public Commissariat (){
		...
		this.indiceCom = commissariats.size();
		...
		this.pInfluence = this.nbSalarie*(10+this.nbCadre/10)/100; //le Potentiel d'influence est l'attribut qui permet aux commissariat de nettoyer la racaille et les criminels. Moins efficace contre le terrorisme
	}
